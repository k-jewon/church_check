...
- **비고**: 마지막 출석(본당 포함, 기록이 없으면 명단 등록일)에서 3개월이 지난 사람은 속·새가족 격자에서 빠지고, 그중 6개월이 지나지 않은 사람을 비고에 성도 → 새가족 순으로 적는다. 새가족은 인도자가 있으면 `이름(인도자)`로 적는다. 군인은 제외한다. 기준일은 출력 기간의 마지막 주일이다.
